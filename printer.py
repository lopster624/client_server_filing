...
def print_changes(data):
    new, deleted, changed = data
    if new or deleted or changed:
        print("==================")
        for path, size in new.items():
            print("path: {}, size: {}, was created".format(path, size))
        for path, size in deleted.items():
            print("path: {}, size: {}, was deleted".format(path, size))
        for path, size in changed.items():
            print("path: {}, size: {}, was changed".format(path, size))
